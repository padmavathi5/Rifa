...
//                Toast.makeText(MainActivity.this,"Safe Move function has to be implemented",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(MainActivity.this,SafeMove.class));
            }
        });
...
//                                    tvtext.setText(""+location.getLatitude()+" "+location.getLongitude());
                                    geo =getname(location.getLatitude(),location.getLongitude());
...
//            tvtext.setText(""+mLastLocation.getLatitude()+" "+mLastLocation.getLongitude());
                geo =getname(mLastLocation.getLatitude(),mLastLocation.getLongitude());
        ...
        try {
            ...
            if (addresses.isEmpty()) {
                ...
                if (addresses.size() > 0) {
                    ...
                    geoLocation = addresses.get(0).getLocality() +", " + addresses.get(0).getAdminArea() + ", " + addresses.get(0).getCountryName();
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
